...
function addLights() {
    ...
    var hemLight = new THREE.HemisphereLight(0xffe5bb, 0xFFBF00, .3);
scene.add(hemLight);
}
...
function addSceneElements() {
    ...
    var floorMat = new THREE.MeshPhongMaterial( { map: THREE.ImageUtils.loadTexture('../img/wood-floor.jpg') } );
    var wallMat = new THREE.MeshPhongMaterial( { map: THREE.ImageUtils.loadTexture('../img/bricks.jpg') } );
    var redMat = new THREE.MeshPhongMaterial( { color: 0xff3300, specular: 0x222222, shininess: 10 } );
    var purpleMat = new THREE.MeshPhongMaterial( { color: 0x6F6CC5, specular: 0x333333, shininess: 10 } );
    ...
    // Knot thingy
    var knot = new THREE.Mesh(new THREE.TorusKnotGeometry( 40, 5, 100, 16 ), purpleMat);
